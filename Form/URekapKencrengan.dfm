object frmRekapKencrengan: TfrmRekapKencrengan
  Left = 171
  Top = 134
  Width = 928
  Height = 462
  Caption = 'Rekap Kencerengan Per Tanggal'
  Color = clBtnFace
    ...
    object cxpgcntrl1: TcxPageControl
      ...
      object cxtbsht1: TcxTabSheet
        ...
        object dxlytcntrl2: TdxLayoutControl
          ...
          object eTotalKencrengan: TcxTextEdit
            Left = 769
            Top = 278
          ...
          object dxlytgrpLayoutControl1Group_Root: TdxLayoutGroup
            ...
            object LCIdxlytcntrl2Item1: TdxLayoutItem
              AlignHorz = ahRight
              CaptionOptions.Text = 'Total Kencrengan'
              Control = eTotalKencrengan
              ControlOptions.ShowBorder = False
            end
          end
        end
  ...
  object pnl1: TPanel
    ...
    object lbl1: TLabel
      ...
      Width = 371
      Height = 16
      Caption = 'Rekapitulasi Penerimaan Berdaasarkan Nilai Kencerengan'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -13
      Font.Name = 'Verdana'
  ...
  object cxgrdvwrpstry1: TcxGridViewRepository
    ...
    object gridRekap: TcxGridDBTableView
      ...
      object gcolmRekapnominal: TcxGridDBColumn
        Caption = 'Nominal'
      ...
      object gcolmRekapjenis_uang: TcxGridDBColumn
        Caption = 'Jenis Uang'
        DataBinding.FieldName = 'jenis_uang'
        HeaderAlignmentHorz = taCenter
        Width = 487
      end
      object gcolmRekapqty: TcxGridDBColumn
        Caption = 'Qty'
  ...
  object spRekap: TADOStoredProc
    ...
    ConnectionString = 
      ...
      'ntb'
    CursorType = ctStatic
    ProcedureName = 'sp_rekap_kencrengan'
    Parameters = <
      item
        Name = 'tanggal'
        DataType = ftString
  ...
  object prprtRekap: TppReport
    ...
    object phdrbnd1: TppHeaderBand
      ...
      object plbl2: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'Laporan Rekap Kencerengan Harian'
        Ellipsis = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Tahoma'
    ...
    object pdtlbnd1: TppDetailBand
      ...
      mmHeight = 7144
      mmPrintPosition = 0
      object pdbtxtnominal: TppDBText
        UserName = 'pdbtxtnominal'
        HyperlinkColor = clBlue
        Border.BorderPositions = []
        Border.Color = clBlack
        Border.Style = psSolid
      ...
      object pdbtxtjenis_uang: TppDBText
        UserName = 'pdbtxtjenis_uang'
        HyperlinkColor = clBlue
        Border.BorderPositions = []
        Border.Color = clBlack
        Border.Style = psSolid
        Border.Visible = False
        DataField = 'jenis_uang'
        DataPipeline = pdbpln1
        Ellipsis = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object pdbtxttotal: TppDBText
        UserName = 'pdbtxttotal'
        HyperlinkColor = clBlue
        Border.BorderPositions = []
        Border.Color = clBlack
        Border.Style = psSolid
  ...
  object spTotalRekap: TADOStoredProc
    Tag = 1
    ConnectionString = 
      'Provider=MSDASQL.1;Persist Security Info=False;Data Source=dasi_' +
      'ntb'
    CursorType = ctStatic
    ProcedureName = 'sp_rekap_total_kencrengan'
    Parameters = <
      item
        Name = 'tanggal'
        DataType = ftString
