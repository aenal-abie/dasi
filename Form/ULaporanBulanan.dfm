object frmLaporanBulanan: TfrmLaporanBulanan
  Left = 130
  Top = 69
  Width = 928
  Height = 557
  ...
  object dxlytcntrl1: TdxLayoutControl
      ...
      object cxtbsht1: TcxTabSheet
        ...
        object dxlytcntrl2: TdxLayoutControl
          ...
          object cxdbpvtgrd1: TcxDBPivotGrid
            ...
            OptionsView.ColumnGrandTotalText = 'Total Per Penerimaan'
            OptionsView.DataFields = False
            OptionsView.FilterFields = False
            OptionsView.FilterSeparator = False
            OptionsView.GrandTotalWidth = 168
            OptionsView.RowFields = False
            OptionsView.RowGrandTotalText = 'Total Penerimaan Per Wilayah'
            TabOrder = 0
            object cxdbpvtgrdfldcxdbpvtgrd1kode_kab: TcxDBPivotGridField
              Area = faColumn
              AreaIndex = 0
              DataBinding.FieldName = 'kode_kab'
              Visible = True
            end
            object cxdbpvtgrdfldcxdbpvtgrd1subtotal: TcxDBPivotGridField
              Area = faData
              AreaIndex = 0
            ...
            object cxdbpvtgrdfldcxdbpvtgrd1nama_perkiraan: TcxDBPivotGridField
              Area = faRow
              AreaIndex = 0
      ...
      object cxtbsht3: TcxTabSheet
        ...
        object dxlytcntrl4: TdxLayoutControl
          ...
          object cxdbpvtgrd2: TcxDBPivotGrid
            ...
            Groups = <>
            OptionsView.ColumnFields = False
            OptionsView.ColumnGrandTotalText = 'Total Penyaluran '
            OptionsView.DataFields = False
            OptionsView.FilterFields = False
            OptionsView.RowFields = False
            OptionsView.RowGrandTotalText = 'Total Per Wilayah'
            TabOrder = 0
            object cxdbpvtgrdfldcxdbpvtgrd2kode_kab: TcxDBPivotGridField
              Area = faColumn
              AreaIndex = 0
              DataBinding.FieldName = 'kode_kab'
              Visible = True
            ...
            object cxdbpvtgrdfldcxdbpvtgrd2sub_total: TcxDBPivotGridField
              Area = faData
              AreaIndex = 0
            ...
            object cxdbpvtgrdfldcxdbpvtgrd2nama_perkiraan: TcxDBPivotGridField
              Area = faRow
              AreaIndex = 0
              DataBinding.FieldName = 'nama_perkiraan'
              Visible = True
          ...
          object dxlytgrp3: TdxLayoutGroup
            ...
            Hidden = True
            ShowBorder = False
            object lbldxlytcntrl4Item1: TdxLayoutItem
              AlignHorz = ahClient
              AlignVert = avClient
              Control = cxdbpvtgrd2
              ControlOptions.ShowBorder = False
        ...
        object dxlytcntrl3: TdxLayoutControl
          ...
          object dxlytgrp2: TdxLayoutGroup
            ...
            object dxlytgrpdxlytcntrl2Group5: TdxLayoutGroup
              ...
              object LCIdxlytcntrl3Item1: TdxLayoutItem
                AlignVert = avCenter
                CaptionOptions.Visible = False
                Control = cbxland
                ControlOptions.ShowBorder = False
    ...
    object cbbPeriode: TcxExtLookupComboBox
      ...
      Properties.OnChange = cbbPeriodePropertiesChange
      Style.HotTrack = False
      TabOrder = 1
      Width = 230
    end
    ...
    object cbxexcel: TcxCheckBox
      Left = 10
      Top = 10
      Caption = 'Cetak Sebagai File Excel'
      Style.HotTrack = False
      TabOrder = 0
      Width = 121
    end
    ...
    object cbxHeader: TcxCheckBox
      Left = 527
      Top = 40
      Hint = 'Buat Berdasarkan Kelompok Ketika Mengexport Data Ke Excel'
      Caption = 'Buat Group (Export Excel)'
  ...
  object pnl1: TPanel
    ...
    object lbl1: TLabel
      ...
      Width = 228
      Height = 14
      Caption = 'Laporan Penerimaan/Pengeluaran Bulanan'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -12
      Font.Name = 'Tahoma'
  ...
  object cxgrdvwrpstry1: TcxGridViewRepository
    ...
    object gridPenerimaan: TcxGridDBTableView
      ...
      object gcolmPenerimaanNamaPerkiraan: TcxGridDBColumn
        DataBinding.FieldName = 'Nama Perkiraan'
      end
      object gcolmPenerimaanLOBAR: TcxGridDBColumn
        DataBinding.FieldName = 'LOBAR'
      end
      object gcolmPenerimaanLOTENG: TcxGridDBColumn
        DataBinding.FieldName = 'LOTENG'
      end
    end
  end
  object spPenerimaan: TADOStoredProc
    ...
    ConnectionString = 
      ...
      'ntb'
    CursorType = ctStatic
    ProcedureName = 'sp_bulanan_penerimaan'
    Parameters = <
      item
        Name = 'tgl1'
        DataType = ftString
  ...
  object pdbplnPenerimaan: TppDBPipeline
    DataSource = dsRekap
    UserName = 'pdbplnPenerimaan'
    Left = 152
    Top = 344
  end
  object prprtPenerimaan: TppReport
    AutoStop = False
    DataPipeline = pdbplnPenerimaan
    ...
    XLSSettings.ExportComponents = [ecText]
    XLSSettings.OpenXLSFile = True
    Left = 192
    Top = 344
    Version = '12.03'
    mmColumnWidth = 0
    DataPipelineName = 'pdbplnPenerimaan'
    object phdrbnd1: TppHeaderBand
      ...
      object lbl3: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'Laporan Rekap Penerimaan Bulanan'
        Ellipsis = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Tahoma'
      ...
      object lblTanggal: TppLabel
        UserName = 'lblTanggal1'
        HyperlinkColor = clBlue
        Border.BorderPositions = []
        Border.Color = clBlack
        Border.Style = psSolid
    ...
    object rcdmdl2: TraCodeModule
      ProgramStream = {
        ...
        
        ...
        75726365069870726F63656475726520706372737462324F6E476574546F7461
        ...
        0D0A20206154657874203A3D27546F74616C273B0D0A0D0A656E643B0D0A0D43
        6F6D706F6E656E744E616D65060770637273746232094576656E744E616D6506
        154F6E476574546F74616C43617074696F6E54657874074576656E744944023C
        0000}
    end
  ...
  object spPengeluaran: TADOStoredProc
    ...
    ConnectionString = 
      ...
      'ntb'
    CursorType = ctStatic
    ProcedureName = 'sp_bulanan_pengeluran'
    Parameters = <
      item
        Name = 'tglawal'
        DataType = ftString
  ...
  object sp1: TADOStoredProc
    ...
    ConnectionString = 
      ...
      'ntb'
    CursorType = ctStatic
    ProcedureName = 'sp_bulanan_penerimaan_p'
    Parameters = <
      item
        Name = 'tgl_mulai'
        Size = -1
  ...
  object cxgrdvwrpstry2: TcxGridViewRepository
    ...
    object gridPengeluaran: TcxGridDBTableView
      ...
      OptionsView.GroupByBox = False
      OptionsView.Indicator = True
      object gcolm1: TcxGridDBColumn
        DataBinding.FieldName = 'Nama Perkiraan'
      end
      object gcolm2: TcxGridDBColumn
        DataBinding.FieldName = 'LOBAR'
      end
      object gcolm3: TcxGridDBColumn
        DataBinding.FieldName = 'LOTENG'
      end
    end
  end
  object sp2: TADOStoredProc
    ...
    ConnectionString = 
      ...
      'ntb'
    CursorType = ctStatic
    ProcedureName = 'sp_bulanan_pengeluaran_p'
    Parameters = <
      item
        Name = 'tgl_mulai'
        Size = -1
  ...
  object cxgrdvwrpstryPeriode: TcxGridViewRepository
    Left = 864
    Top = 68
