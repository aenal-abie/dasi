object frmTransaksiPePerkiraan: TfrmTransaksiPePerkiraan
  Left = 270
  Top = 113
  Width = 928
  Height = 419
  Caption = 'TRANSAKSI PER PERKIRAAN'
  Color = clBtnFace
  ...
  object dxlytcntrl1: TdxLayoutControl
    ...
    object grid1: TcxGrid
      ...
      object gridMutasi: TcxGridDBTableView
        ...
        DataController.Summary.FooterSummaryItems = <
          ...
          item
            Format = 'Rp,0.00;(Rp,0.00)'
            Kind = skSum
            FieldName = 'saldo_operasional'
            Column = gcolmMutasisaldo_operasional
          end
          item
            Format = 'Rp,0.00;(Rp,0.00)'
            Kind = skSum
            FieldName = 'saldo_penyaluran'
            Column = gcolmMutasisaldo_penyaluran
          end>
        ...
        object gcolmMutasikode_donatur: TcxGridDBColumn
          Caption = 'Kode Donatur'
          DataBinding.FieldName = 'kode_donatur'
          Width = 100
        end
        object gcolmMutasinama_lengkap: TcxGridDBColumn
          Caption = 'Nama Donatur'
          DataBinding.FieldName = 'nama_lengkap'
          Width = 264
        end
        object gcolmMutasinama_amil: TcxGridDBColumn
          Caption = 'Nama Amil'
          DataBinding.FieldName = 'nama_amil'
          Width = 265
        end
        object gcolmMutasikode_kwitansi: TcxGridDBColumn
          Caption = 'No Kwitansi'
          DataBinding.FieldName = 'kode_kwitansi'
          Width = 109
        end
        object gcolmMutasisubtotal: TcxGridDBColumn
          Caption = 'Total Penerimaan'
          DataBinding.FieldName = 'subtotal'
          PropertiesClassName = 'TcxCurrencyEditProperties'
          Width = 184
        end
        object gcolmMutasisaldo_penyaluran: TcxGridDBColumn
          Caption = 'Penyaluran'
        ...
        object gcolmMutasisaldo_operasional: TcxGridDBColumn
          Caption = 'Operasional'
          DataBinding.FieldName = 'saldo_operasional'
          PropertiesClassName = 'TcxCurrencyEditProperties'
          Properties.DisplayFormat = 'Rp,0.00;(Rp,0.00)'
          Width = 123
        end
      ...
      object gridPengeluaran: TcxGridDBTableView
        ...
        DataController.Summary.FooterSummaryItems = <
          item
            Kind = skCount
            FieldName = 'tanggal'
            Column = gcolmgrid1DBTableView1tanggal
          end
          item
            Format = 'Rp,0.;(Rp,0.)'
            Kind = skSum
            FieldName = 'sub_total'
            Column = gcolmgrid1DBTableView1sub_total
          end>
        DataController.Summary.SummaryGroups = <>
        OptionsCustomize.ColumnFiltering = False
        OptionsData.Deleting = False
        ...
        OptionsView.Indicator = True
        OptionsView.IndicatorWidth = 20
        object gcolmgrid1DBTableView1kode_pengeluaran: TcxGridDBColumn
          Caption = 'Kode Pengeluaran'
          DataBinding.FieldName = 'kode_pengeluaran'
          Width = 82
        end
        object gcolmgrid1DBTableView1tanggal: TcxGridDBColumn
          Caption = 'Tanggal'
          DataBinding.FieldName = 'tanggal'
          Width = 95
        end
        object gcolmgrid1DBTableView1nama_perkiraan: TcxGridDBColumn
          Caption = 'Tujuan Perkiraan'
          DataBinding.FieldName = 'nama_perkiraan'
          Width = 118
        end
        object gcolmgrid1DBTableView1keterangan: TcxGridDBColumn
          Caption = 'Keterangan'
          DataBinding.FieldName = 'keterangan'
          Width = 501
        end
        object gcolmgrid1DBTableView1sub_total: TcxGridDBColumn
          Caption = 'Jumlah'
      ...
      object gridPeminjaman: TcxGridDBTableView
        NavigatorButtons.ConfirmDelete = False
        NavigatorButtons.First.Visible = True
        NavigatorButtons.PriorPage.Visible = True
        NavigatorButtons.Prior.Visible = True
        ...
        OptionsView.Indicator = True
        OptionsView.IndicatorWidth = 20
        object gcolmPeminjamanid: TcxGridDBColumn
          Caption = 'ID'
          DataBinding.FieldName = 'id'
          Width = 26
        end
        object gcolmPeminjamantgl: TcxGridDBColumn
          Caption = 'Tanggal'
          DataBinding.FieldName = 'tgl'
          Width = 43
        end
        object gcolmPeminjamandari: TcxGridDBColumn
          Caption = 'Perkiraan'
          DataBinding.FieldName = 'dari'
          Width = 85
        end
        object gcolmPeminjamansumber: TcxGridDBColumn
          Caption = 'Sumber'
          DataBinding.FieldName = 'sumber'
          Width = 101
        end
        object gcolmPeminjamanke: TcxGridDBColumn
          Caption = 'Perkiraan'
          DataBinding.FieldName = 'ke'
          Width = 66
        end
        object gcolmPeminjamantujuan: TcxGridDBColumn
          Caption = 'Tujuan'
          DataBinding.FieldName = 'tujuan'
          Width = 136
        end
        object gcolmPeminjamanketerangan: TcxGridDBColumn
          Caption = 'Keterangan'
          DataBinding.FieldName = 'keterangan'
          Width = 252
        end
        object gcolmPeminjamanjumlah: TcxGridDBColumn
          Caption = 'Jumlah'
          DataBinding.FieldName = 'jumlah'
          PropertiesClassName = 'TcxCurrencyEditProperties'
          Width = 92
        end
        object gcolmPeminjamanstatus: TcxGridDBColumn
          Caption = 'Status'
  ...
  object pnl1: TPanel
    ...
    object lbl1: TLabel
      ...
      Width = 285
      Height = 16
      Caption = 'Melihat Transaksi Penerimaan Per Perkiraan'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -13
      Font.Name = 'Verdana'
  ...
  object qryData: TADOQuery
    ...
    SQL.Strings = (
        ...
        'CALL `sp_view_trans_pertrans`(:perkiraan,:tglawal,:tglakhir,:ope' +
        'rasional)')
    Left = 728
    Top = 108
  end
  ...
  object qryPeminjaman: TADOQuery
    ...
    Prepared = True
    SQL.Strings = (
      'CALL `sp_view_peminjaman_per_perkiraan`(:id,:tgl, :tgl2)')
    Left = 432
    Top = 188
  end
  object dxcmpntprntr1: TdxComponentPrinter
    ...
    object dxgrdrprtlnkGridPrintTransaski: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 41738.642790011570000000
